...
def vertical_horizontal(img):
        ...
        if faces != []:
            ...
            if points.shape[0] == 0:
                ...
                return 0, 0
            elif check_if_good(img, face_width) and face_width != 0:
...
def face(img, vertical_distans,horizontal_distans, request):
    # print("ver= "+ str(vertical_distans))
    # print("hor= "+str(horizontal_distans))
    
    if  vertical_distans > 30 and request=="open_mouth" :
        return "open", vertical_distans
        
    if vertical_distans < 20 and request=="open_mouth" :
        return "close", 0
    
    if horizontal_distans > 70 and request=="smile" :
        return "open", horizontal_distans
    
    if horizontal_distans <60 and  request=="smile" :
        return "close", 0
        
    if horizontal_distans < 55  and request=="kiss" :
        return "open", horizontal_distans
    
    if horizontal_distans > 60  and request=="kiss" :
        return "close", 0
    ...
    if request == "down":
        ...
        if vertical_distans < 30 and distance == None  :
            return "close", 0

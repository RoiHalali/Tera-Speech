...
class DriveAPI:
    ...
    def FileUpload(self, filepath, user_dir):
    ...
    def FileUpdate(self, file_id, name, path):
        ...
        try:
            media_content = MediaFileUpload(path, mimetype=mimetype)
